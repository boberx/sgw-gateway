...
/** @brief Ask the central server to pre-authentication a client */
#define REQUEST_TYPE_PREAUTH     "preauth"
...
t_authcode auth_server_request_preauth ( t_authresponse*, const char* );
