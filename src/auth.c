...
*/
void thread_client_timeout_check ( __attribute__((unused)) const void* arg )
{
...
authenticate_client(request * r)
{
    ...
    case AUTH_ALLOWED:
        ...
        debug(LOG_NOTICE, "Got ALLOWED from central server authenticating token %s from %s at %s - "
    ...
    case AUTH_VALIDATION_FAILED:
        ...
        debug(LOG_NOTICE, "Got VALIDATION_FAILED from central server authenticating token %s from %s at %s "
