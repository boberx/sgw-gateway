...
/*!
*	/brief Сохранить список клиентов в файл (только уже аутентифицированные (fw_connection_state==FW_MARK_KNOWN))
	/brief формат файла: magic,file size,{ip,mac,token},...
*	/return 0 на ошибку иначе 1
*/
char client_list_save ();

/*!
*	/brief Загрузить список клиентов из файла
*/
char client_list_load ();

/*!
*	/brief Установить флаг наличия обновлений в списке клиентов
*/
void client_list_set_update_flag ( char flag );

/*!
*	/brief Получить флаг обновления списка клиентов
*/
char client_list_get_update_flag ();
