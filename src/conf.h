...
#define DEFAULT_CHECKINTERVAL_MIN 300
#define DEFAULT_CHECKINTERVAL_MAX 600
...
typedef struct {
	...
	/*!
	*	/brief хранит инф. об аутентифицированных клиентах
	*/
	char* authfile;
	...
	/*
	*	Флаг включения режима преаутентификации. Без него не работате cportal (> 3.0), поэтому позже удалю возможность отключения.
	*/
	char preauth;
} s_config;
